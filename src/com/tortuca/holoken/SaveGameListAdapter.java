...
public class SaveGameListAdapter extends BaseAdapter {
	...
	public class SortSavedGames implements Comparator<String> {
		...
		public int compare(String object1, String object2) {
			try {
				save1 = new SaveGame(SaveGameListActivity.SAVEGAME_DIR + "/"
						+ object1).ReadDate();
				save2 = new SaveGame(SaveGameListActivity.SAVEGAME_DIR + "/"
						+ object2).ReadDate();
			} catch (Exception e) {
				//
			}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TextView gametitle = (TextView) convertView
				.findViewById(R.id.saveGameTitle);
		TextView datetime = (TextView) convertView
				.findViewById(R.id.saveDateTime);

		final String saveFile = SaveGameListActivity.SAVEGAME_DIR + "/"
				+ this.mGameFiles.get(position);

		this.preferences = PreferenceManager
				.getDefaultSharedPreferences(convertView.getContext());
		...
		ImageButton loadButton = (ImageButton) convertView
